...
exec_test "./nanotekspice ressources/basics/adder.nts a=1 b=1 a2=1 b2=1 a3=1 b3=1 a4=1 b4=1 cin=1" "test02" "adder"
exec_test "./nanotekspice ressources/basics/counter.nts clock=0 reset=0" "test03" "counter"
exec_test "./nanotekspice ressources/basics/d_latch.nts clock=1 data=0 set=0 reset=0" "test04" "d_latch"
...
exec_test "./nanotekspice ressources/basics/johnson.nts clockup=1 master_reset=1" "test16" "johnson"
